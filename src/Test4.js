...
class Test4 extends Component {
    ...
    render() {
        return (
            ...
            <p className="parag">The estimated power generated by the array in the upcoming 24 hrs for different scenarios is:</p>
                ...
                <p style={{color: "yellow"}} className="caption">AC_Power represents “ac_power_output_data.json”</p>
                <p style={{color: "red"}} className="caption">AC_Power_1 represents “ac_power_winter_data.json”</p>
                <p style={{color: "green"}} className="caption">AC_Power_2 represents “ac_power_summer_data.json”</p>
                <p style={{color: "blue"}} className="caption">AC_Power_3 represents “ac_power_tracker_data.json” </p>
            </div>
        )
    }
